package sri.examples.collections.class_methods.challenge.poker;
...
public class PokerGame {
    ...
    public void startPlay(){
        ...
        int cardsDelt = playerCount * cardsInHand;
        int cardsRemaining = deck.size() - cardsDelt;
        remainingCards=new ArrayList<>(Collections.nCopies(cardsRemaining,null));
        remainingCards.replaceAll(c->deck.get(cardsDelt+remainingCards.indexOf(c)));
